...
### `plot_detector_level(test_dataset: ArrayDataset[np.double], g: keras.Model, save_path: Path = Path("plots/detector_level.pdf"), var_info: list[VarInfo] | None = None, omnifold_weights: NDArray[np.double] | None = None, ibu_weights: list[NDArray[np.double]] | None = None) -> None:`
...
- `omnifold_weights: NDArray[np.double] | None` The per-event OmniFold weights for MC events.
...
### `plot_particle_level(test_dataset: ArrayDataset[np.double], g: keras.Model, save_path: Path = Path("plots/particle_level.pdf"), var_info: list[VarInfo] | None = None, omnifold_weights: NDArray[np.double] | None = None, ibu_weights: list[NDArray[np.double]] | None = None) -> None:`
